...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(data: $data, statusCode: $statusCode, message: $message, errors: $errors, pageNo: $pageNo, loading: $loading, pagination: $pagination, searchLoading: $searchLoading, paginationLoading: $paginationLoading)';
  }
